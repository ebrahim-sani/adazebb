  ...
  return (
    <div className="app">
      <Routes location={location} key={location.pathname}>
        ...
        />
        <Route exact path="/client/customers" element={<CustomersView />} />
        <Route exact path="/client/products" element={<ProductView />} />
        <Route exact path="/dashboard/client" element={<DashboardView />} />
