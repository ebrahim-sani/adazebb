        ...
        <div className="app__showcase">
            <div className="app__showcase-component">
                <div className="app__showcase-right">
                    ...
                    <p>
                        Design to deliver the best experience and accessiblity
                        possible, Adazeb is also available for download on your
                        mobile phone. You can download it on play store.
                    </p>
