        ...
        <div className="app__footer">
            <div className="app__footer-component">
                <div className="app__footer-right">
                    ...
                    <p>
                        Adazeb is a digital solution that helps you simplify
                        your inventory management processes. Monitor inventory,
                        find customer trends and track payments all-in-one box.
                    </p>
                </div>
            ...
            <p>&copy; Global Adazeb - 2022. All Rights Reserved.</p>
        </div>
    );
}
